...
namespace backend\modules\image\components;

use yii\base\Component;
use backend\modules\image\models\Image;
use backend\modules\image\components\ImgException;
    ...
    public function save($file, $name = null, $path = null, $id = null) {
        ...
        try {
            ...
            if ($id > 0) {
                ...
                $image = new \backend\modules\image\models\Image();
    ...
    public function createVersion($id, $version) {
        if (isset($this->versions[$version])) {
            ...
            if ($image != null) {
                ...
                \yii\imagine\Image::getImagine()->open($this->_basePath . '/files/images/' . $fileName)->thumbnail(new Box($options->width, $options->height))->save($path, ['quality' => 90]);
                return $path;
            } else
            //return $id;
