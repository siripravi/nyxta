 ...
 */
class Product extends \abcms\library\base\BackendActiveRecord implements CartPositionInterface

{
    ...
    public function rules()
    {
        return [
            ...
            [['description'], 'string'],
            [['category_id','price','quantity'], 'number'],
    ...
    {
        return Image::find()->where(['name' => 'id'])->asArray()->all();
    }
 ...
 public function getImageUrlById($id)
    {
        ...
        return self::formatImageUrl($product->image);
    }
